...
"[project]/app/api/flowers/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('flowers').select('*').eq('slug', slug).single();
    if (error || !data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19c884a5._.js.map